...
/// <summary>
/// Declares a root type that is supported by a source-generated
/// <see cref="MemoryPackSerializerContext"/>.
/// </summary>
[AttributeUsage(AttributeTargets.Class, AllowMultiple = true, Inherited = false)]
public sealed class MemoryPackSerializableAttribute : Attribute
{
    public Type Type { get; }

    /// <summary>
    /// Gets or sets an optional formatter or context formatter factory for an
    /// external type that is not generated by MemoryPack.
    /// </summary>
    public Type? FormatterType { get; set; }

    public MemoryPackSerializableAttribute(Type type)
    {
        Type = type;
    }
}

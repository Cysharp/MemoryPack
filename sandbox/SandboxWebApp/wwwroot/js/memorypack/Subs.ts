...
export class Subs {
    ...
    static serialize(value: Subs | null): Uint8Array {
        const writer = MemoryPackWriter.getSharedInstance();
        this.serializeCore(writer, value);
        return writer.toArray();
    }

    static serializeCore(writer: MemoryPackWriter, value: Subs | null): void {
        if (value == null) {
    ...
    static deserialize(buffer: ArrayBuffer): Subs | null {
        return this.deserializeCore(new MemoryPackReader(buffer));
    }

    static deserializeCore(reader: MemoryPackReader): Subs | null {

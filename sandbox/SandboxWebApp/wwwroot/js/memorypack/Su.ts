...
export class Su {
    ...
    static serialize(value: Su | null): Uint8Array {
        const writer = MemoryPackWriter.getSharedInstance();
        this.serializeCore(writer, value);
        return writer.toArray();
    }

    static serializeCore(writer: MemoryPackWriter, value: Su | null): void {
        if (value == null) {
    ...
    static deserialize(buffer: ArrayBuffer): Su | null {
        return this.deserializeCore(new MemoryPackReader(buffer));
    }

    static deserializeCore(reader: MemoryPackReader): Su | null {

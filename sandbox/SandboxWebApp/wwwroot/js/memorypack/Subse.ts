...
export class Subse {
    ...
    static serialize(value: Subse | null): Uint8Array {
        const writer = MemoryPackWriter.getSharedInstance();
        this.serializeCore(writer, value);
        return writer.toArray();
    }

    static serializeCore(writer: MemoryPackWriter, value: Subse | null): void {
        if (value == null) {
    ...
    static deserialize(buffer: ArrayBuffer): Subse | null {
        return this.deserializeCore(new MemoryPackReader(buffer));
    }

    static deserializeCore(reader: MemoryPackReader): Subse | null {
